    ...
    <header className="flex h-16 w-full shrink-0 items-start gap-2 px-4 pb-1 pt-4">
      ...
      <div className="flex items-center justify-center gap-2">
        ...
        <button
          type="button"
          disabled
          className="flex h-8 cursor-not-allowed items-center justify-center rounded-[12px] bg-[var(--colors-fill-secondary-disabled)] px-[10px] py-[6px]"
        >
        ...
        {/* vertical separator */}
        <span className="h-4 w-px rounded-full bg-[var(--colors-fill-secondary)]" />
      ...
      <div className="flex flex-1 items-center justify-end gap-2 pl-2 pr-1">
        <div className="flex items-center gap-2 pl-2">
          ...
          <button
            type="button"
            className="flex h-8 cursor-pointer items-center justify-center rounded-[12px] border border-[var(--colors-border-secondary)] px-[10px] py-[6px] transition-colors hover:bg-[var(--colors-fill-secondary)]"
          >
            <span className="flex items-center gap-[6px]">
              <span className="flex items-center gap-[6px]">
